                ...
                <ul class="list-unstyled">
                    <li class="mb-3">
                        <p><strong><i class="bi bi-calendar-event-fill text-warning"></i> Fondation:</strong> Le club a
                            été fondé en <time datetime="2000-01-01"><?= esc('janvier 2000'); ?></time>. Notre objectif
                            était de créer une communauté de passionnés de sport qui apprécient le travail d'équipe, le
                            dépassement de soi et le respect mutuel.</p>
                    </li>
                    <li class="mb-3">
