...
<div>
    ...
    <!-- Formulaire d'ajout -->
    <form id="formulaire" class="card shadow-lg border-0 mb-5 p-4" style="display:none;" method="post" action="<?= url_to('equipeSubmit') ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-12 text-center mb-3">
                <img id="photoPreview" src="#" alt="Prévisualisation" class="img-fluid shadow rounded-circle" style="max-width: 150px; display: none;">
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card shadow-lg border-0 h-100">
                    <div class="text-center mt-4">
                        <img src="<?= base_url($e['photo']) ?>" class="img-fluid rounded-circle shadow" alt="<?= $e['prenom'] . ' ' . $e['nom'] ?>" style="width: 150px; height: 150px; object-fit: cover;">
                    </div>
                    ...
                    <div class="card-footer text-center">
                        <button class="btn btn-warning btn-sm me-2 bouton-modifier" data-id="<?= $e['idAdherant'] ?>" data-nom="<?= $e['nom'] ?>" data-prenom="<?= $e['prenom'] ?>" data-grade="<?= $e['grade'] ?>" data-photo="<?= base_url($e['photo']) ?>" data-bs-toggle="modal" data-bs-target="#modalModifier">Modifier</button>
                        <form action="<?= route_to('equipeDelete') ?>" method="post" class="d-inline">
                            <input type="hidden" name="idAdherant" value="<?= $e['idAdherant'] ?>">
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet adhérent ?');">
                                Supprimer
                            </button>
                        </form>
                    </div>
...
<div class="modal fade" id="modalModifier" tabindex="-1" aria-labelledby="modalModifierLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="formulaire-modifier" method="post" action="<?= url_to('equipeUpdate') ?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="modifier-photo" name="photo" accept="image/*" onchange="previewImage(event, 'modifierPhotoPreview')">
                    </div>
                </div>
